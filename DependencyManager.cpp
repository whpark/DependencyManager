...
BEGIN_MESSAGE_MAP(CDependencyManagerApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CDependencyManagerApp::OnAppAbout)
...
CDependencyManagerApp::CDependencyManagerApp() noexcept {
	...
	SetAppID(_T("DependencyManager.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CDependencyManagerApp object

CDependencyManagerApp theApp;
...
BOOL CDependencyManagerApp::InitInstance() {
	...
	pDocTemplate = new CMultiDocTemplate(IDR_DependencyManagerTYPE,
		RUNTIME_CLASS(CDependencyManagerDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CDependencyManagerView));
	if (!pDocTemplate)
		return FALSE;
